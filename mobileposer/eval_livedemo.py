...
model_lstm.restore('data/checkpoints/calibrator/RealData_0915_4pants_1234/RealData_0915_4pants_1234.pth')

model_tic = model_tic.to(device).eval()
model_lstm = model_lstm.to(device).eval()

# folders = ['sit_20250811_180140']
eval_dir = "/root/autodl-tmp/data/Real_Dataset/RealData_Raw_0915_types/pants_5"
    ...
    for type in types:
        ...
        if type != 'gt' and not f.startswith('live'):
            ...
            for key in errors:
                ...
                # 累积到全局统计
                global_errors[type][key].append(mean_error)
            print()
